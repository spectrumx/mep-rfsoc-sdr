...
# False paths between PL clocks and RFDAC clocks
set_false_path -setup -from [get_clocks *clk_pl_0*] -to [get_clocks {RFDAC0_CLK RFDAC2_CLK}]
set_false_path -setup -from [get_clocks {RFDAC0_CLK RFDAC2_CLK}] -to [get_clocks *clk_pl_0*]
