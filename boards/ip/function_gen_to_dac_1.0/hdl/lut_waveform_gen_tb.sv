...
module lut_waveform_gen_tb;
    ...
    initial begin
        ...
        begin
            static integer sample_count = 0;
            static integer sine_max = 0;
            static integer sine_min = 16383;
            static integer cosine_max = 0;
            static integer cosine_min = 16383;
            static integer center_crossings = 0;
            static reg [DATA_WIDTH-1:0] prev_sine = 0;
            static integer center_value = 8192;  // Center value for unsigned 14-bit waveform
